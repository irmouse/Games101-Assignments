                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    Vector3f N = normalize(crossProduct(e0, e1));  // 三角形法向量
    ...
    float tn = dotProduct(S2, E2) / dotProduct(S1, E1);
...
public:
                              ...
                              Vector2f& st) const override
    {
        ...
        Vector3f e0 = normalize(v1 - v0);
        Vector3f e1 = normalize(v2 - v1);
        N = normalize(crossProduct(e0, e1));  // 三角形法向量
